--==============================================================================
-- ? PRD SERVER | BATCH | ODS | MONTH WITH SESSION
-- ?? : 
--==============================================================================

DROP TABLE TBL_PRTC_LOG;
-- WILL BE USE SQLCODE, SQLERRM
-- STATUS : START, UPDATE, FINISH, ERROR
CREATE TABLE TBL_PRTC_LOG   
(
    STATUS VARCHAR2(6), STEP VARCHAR2(2)
...
(ID NUMBER, NAME VARCHAR2(30), USERNAME VARCHAR2(20), EMAIL VARCHAR2(50), PHONE VARCHAR2(30), CONTENTS VARCHAR2(255), CREATE_TIME TIMESTAMP);
...
(ID NUMBER, NAME VARCHAR2(30), USERNAME VARCHAR2(20), EMAIL VARCHAR2(50), PHONE VARCHAR2(30), CONTENTS VARCHAR2(255), UPDATE_TIME TIMESTAMP);
